...
const tiers = [
  {
    ...
    features: [
      ...
      "Bodies are not logged (size + SHA-256 only for non-text)",
  ...
  },
  {
    ...
    features: [
      ...
      "Up to 5 torans",
      "Optional text body logging (UTF-8 only); non-text stored as size + SHA-256",
  ...
  },
  {
    ...
    features: [
      ...
      "Up to 20 torans",
      "Higher usage caps",
      "Text body logging (UTF-8 only); non-text stored as size + SHA-256",
      "Log export",
